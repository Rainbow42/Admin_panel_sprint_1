    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='persons.person')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='filmwork',
            name='person',
            field=models.ManyToManyField(blank=True, related_name='person', through='movies.FilmWorkPersonsType', to='persons.Person', verbose_name='Персона'),
        ),
